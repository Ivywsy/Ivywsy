...
| <a href="https://github.com/Ivywsy/EDA_ggplot2"><img src="/images/EDA.png?raw=true" width="550"/></a>  | [Exploratory Data Analysis With Visualizations (ggplot2)](https://github.com/Ivywsy/EDA_ggplot2)<br/>Created <b>data visualizations</b> with <b>ggplot2</b> in <b>R</b> to <b>reveal the initial patterns and characteristics</b>  of a dataset. The process of exploration involves identifying the presence of outliers, the distribution of data values, the structure of the dataset and the relationships between different data variables. |
